...
#### Fixed
- Multi-driver scenarios: per-driver shadow subclasses isolate driver-specific methods when multiple driver
types are active, preventing cross-driver method overwrites on shared Element/Page classes.
